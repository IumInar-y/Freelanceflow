...
export const navItems: NavItem[] = [
  ...
  { label: 'Install Extension', href: '/extension', group: 'primary', order: 3 },
  {
    label: 'Blog',
    href: '/blog',
    group: 'primary',
  ...
  { label: 'Get Started', href: '/signup', group: 'secondary', order: 1 },
  { label: 'Profile', href: '/profile', group: 'footer', requiresAuth: true },
  { label: 'Upsell Analytics', href: '/admin/analytics', group: 'footer', requiresAuth: true },
  { label: 'Grant Pro', href: '/admin/grant-pro', group: 'footer', requiresAuth: true },
];
